...
<ol>
    ...
    <ul>
        <li>Ajouter des alertes de succès et d'erreurs</li>
    </ul>
    ...
    <li>Ajouter un champ "note" dans showBook.view.php et updateBook.view.php</li>

</ol>

<h2>Mises à jours secondaires:</h2>
<ol>
    <li>Ajouter une page d'accueil avec lien LinkedIn, github et explication technique du projet</li>
